...
<%
String s=request.getParameter("section");
%>
         ...
         <div id="main_slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                  <div class="container">
                     <h1 class="fashion_taital"><%=s.replace('_', ' ') %></h1>
            ...
            try
            {
            	Connection cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/ecommercedbxy?autoReconnect=true&useSSL=false","root","Root@123");
            	PreparedStatement pst=cn.prepareStatement("select * from product where section='"+s+"'");
            ...
            %>
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="buy.jsp?productid=<%=pid%>">Buy Now</a></div>
                                 </div>
                              </div>
                           </div>
                    <%
